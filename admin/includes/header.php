        ...
        <div class="mn-content fixed-sidebar">
            <header class="mn-header navbar-fixed">
                ...
                <nav class="navbar navbar-expand-lg navbar-light py-3 " >
                  ...
                  <marquee width="950px" direction="left" behavior="alternate" ><span style="font-size:38px; width=''font-weight:bold;color:#1F7A8C;font-family:'lobster', cursive;">Hadia-e-Maarif Private School Employee Leave Management System</span>
        </marquee>
